...
$('.scroll-btn--top').click(function(e){
  e.preventDefault();
  $('html, body').animate({scrollTop:$('body').position().top}, 2000);
});
...
// Basic options for a simple Google Map
	...
	var mapOptions = {
		...
		stylers:[{saturation:-100},{lightness:55},{visibility:"on"}]},{featureType:"poi",
		...
		stylers:[{saturation:-50},{visibility:"on"}]},{featureType:"administrative.province",
